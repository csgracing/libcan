...
typedef struct
{
    ...
    can::protocol::classic::frame::data::RTR expected_rtr;
    can::protocol::classic::frame::data::IDE expected_ide;
    can::protocol::classic::frame::data::EDL expected_edl;
    uint8_t expected_dlc;
    uint8_t expected_max_data_size;
    can::protocol::classic::frame::FrameType expected_type;
} create_input_expected;

typedef struct
{
    std::string test_case_display_name;
    can::protocol::classic::frame::frame_raw_t frame_raw;

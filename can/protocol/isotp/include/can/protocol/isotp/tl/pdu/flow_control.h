...
#include "can/protocol/isotp/tl/pci/flow_control.h"
...
namespace can::protocol::isotp::tl::pdu
{
    ...
    {
    private:
        can::protocol::isotp::tl::pci::fc::FlowStatus status;
        uint8_t block_size;
        // TODO make enum or similar (ISO spec - 9.6.5.4 Table 21)
        uint8_t separation_time;

    public:
        FlowControl(can::protocol::isotp::tl::pci::fc::FlowStatus status, uint8_t block_size, uint8_t separation_time);
